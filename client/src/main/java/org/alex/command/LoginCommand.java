...
//        final List<Assignee> listHelper = bootstrap.getAssigneeService().getEndpointAssigneePort().getAllAssignee();
...
//                        System.out.println("Здравствуйте, " + bootstrap.getAssigneeService().getEndpointAssigneePort().getAssignee(assignee.getUid()) + "\n");

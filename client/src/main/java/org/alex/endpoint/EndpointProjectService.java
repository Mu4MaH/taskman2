...
public class EndpointProjectService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.alex.org/", "EndpointProjectService");
    public final static QName EndpointProjectPort = new QName("http://endpoint.alex.org/", "EndpointProjectPort");
    static {
        URL url = null;
        try {

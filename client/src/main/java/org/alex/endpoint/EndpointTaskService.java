...
public class EndpointTaskService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.alex.org/", "EndpointTaskService");
    public final static QName EndpointTaskPort = new QName("http://endpoint.alex.org/", "EndpointTaskPort");
    static {
        URL url = null;
        try {
